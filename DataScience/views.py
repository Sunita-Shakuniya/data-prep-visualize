...
def generate_combinations(available_columns):
    ...
    for r in range(2, max_columns + 1):  # Start from 2 for at least 2 columns, up to max_columns
        combinations.extend(itertools.combinations(available_columns, r))
    return combinations
...
def data_visualization(request):
    ...
    # Generate all possible combinations of columns with at least 2 columns
    all_combinations = generate_combinations(available_columns)
    # Print all combinations
    #print("All possible combinations for visualization:")
    for combination in all_combinations:
        print(combination)
    print(f"Available Columns in visualization: {available_columns}")
